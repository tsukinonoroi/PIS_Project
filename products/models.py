...
class ApartmentImage(models.Model):
    apartment = models.ForeignKey(Apart, on_delete=models.CASCADE, related_name='images', verbose_name='Квартира')
    image = models.ImageField(upload_to='products_images', verbose_name='Изображение')
    ...
    def __str__(self):
        return f'Квартира: {self.apartment.name} | Изображение: {self.image}'
